...
<html>
<head>
	<title>Login Mitra | Medgency</title>
	...
	<style type="text/css">
		*{
		...
		.btn{
			...
			outline: none;
			border: none;
			background-image: linear-gradient(to right, #2180b9, #6dd5fa, #6dd5fa);
			background-size: 200%;
			font-size: 1.2rem;
			color: #fff;
			font-family: 'Poppins', sans-serif;
...
<body>
	...
	<div class="container">
		...
		<div class="login-content">
			<!-- ini form nya -->
			<form action="<?= site_url('mitra/login') ?>" method="post">
				<img src="<?php echo base_url()?>assets/img/avatar.svg">
				<h2 class="title">Medgency</h2>
				<h3 class="title">Login Mitra</h3>
